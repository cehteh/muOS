...
{
  return muos_txqueue_output_char (c);
}
...
{
  return muos_txqueue_output_cstr (str);
}
...
{
  return muos_txqueue_output_cstrn (str, n);
}
...
{
  return muos_txqueue_output_fstr (str);
}
...
{
  return muos_txqueue_output_csi_char (c);
}
...
{
  return muos_txqueue_output_csi_cstr (str);
}
...
{
  return muos_txqueue_output_csi_fstr (str);
}
...
{
  return muos_txqueue_output_intptr (n);
}

static inline muos_error
muos_output_uintptr (uintptr_t n)
{
  return muos_txqueue_output_uintptr (n);
}

static inline muos_error
muos_output_int8 (int8_t n)
{
  return muos_txqueue_output_int8 (n);
}
...
{
  return muos_txqueue_output_upcase (upcase);
}
...
{
  return muos_txqueue_output_base (base);
}
...
{
  return muos_txqueue_output_pupcase (upcase);
}
...
{
  return muos_txqueue_output_pbase (base);
}
