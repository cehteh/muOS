...
#if defined(MUOS_DEBUG) && MUOS_DEBUG_INTR
...
#if defined(MUOS_DEBUG) && MUOS_DEBUG_ERROR
...
#if defined(MUOS_DEBUG) && MUOS_DEBUG_C1
...
#if defined(MUOS_DEBUG) && MUOS_DEBUG_C2
...
#if defined(MUOS_DEBUG) && MUOS_DEBUG_C3
...
#if defined(MUOS_DEBUG) && MUOS_DEBUG_C4
